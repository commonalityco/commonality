...
Commonality will only allow direct dependencies that have the `api` or `internal` tag in it's [package configuration](/sdk/configuration#package-configuration).
...
Commonality will only allow direct dependencies that have the `api` or `internal` tag in its [package configuration](/sdk/configuration#package-configuration).
