...
Selectors are used apply checks constraints and constraints to subsets of packages in a project and are defined in a [project configuration file](/sdk/configuration#project-configuration).
