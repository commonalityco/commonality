...
Commonality is an open-source tool that helps you structure growing [multi-package workspaces](https://vercel.com/docs/vercel-platform/glossary#multi-package-workspace) and package ecosystems.
