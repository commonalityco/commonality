...
Commonality is an open-source tool that helps you structure large [multi-package workspaces](https://vercel.com/vercel-platform/glossary#multi-package-workspace) and package ecosystems.
