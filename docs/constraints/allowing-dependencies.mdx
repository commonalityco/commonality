...
`allow` constraints are used to explicitly define which dependencies a package should have. They are helpful for defining a [hierarchy of packages](/examples/dependency-hierarchy) or [creating workflows](/examples/domain-boundaries).
