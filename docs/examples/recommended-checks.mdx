To get you up and running, we provide some checks that benefit most projects. We also provide some [utility checks](#utility) that can be used to enforce existing conventions within your project.
...
### `has-consistent-external-version`
...
### `has-matching-dev-peer-versions`
