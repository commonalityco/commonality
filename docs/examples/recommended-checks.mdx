To get you up and running, we provide some checks that benefit most projects. We also provide some [composable checks](#composable-checks) that can be used to enforce existing conventions within your project.
