...
2. Install and configure checks that benefit most multi-package projects from [`commonaity-checks-recommended`](/commonality-checks-recommended) (optional)
...
Checks ensure that the structure of a package conforms to a set of rules.
...
![](/images/studio-edit-tags.png)

<Tip>
  Editing tags in Commonality Studio will update or create a
  [`commonality.json`](/sdk/configuration#package-configuration) in package
