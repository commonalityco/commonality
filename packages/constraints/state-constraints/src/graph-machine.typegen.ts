...
"done.invoke.update-layout": { type: "done.invoke.update-layout"; data: unknown; __tip: "See the XState TS docs to learn how to strongly type this." };
"error.platform.render-graph": { type: "error.platform.render-graph"; data: unknown };
"error.platform.update-layout": { type: "error.platform.update-layout"; data: unknown };
...
"zoomOut": "ZOOM_OUT";
        ...
        eventsCausingGuards: {
          "hasInitialized": "DESTROY" | "EDGE_CLICK" | "FIT" | "FOCUS" | "HIDE" | "HIDE_ALL" | "HIDE_DEPENDANTS" | "HIDE_DEPENDENCIES" | "NODE_CLICK" | "NODE_MOUSEOUT" | "SET_HOVERING" | "SET_THEME" | "SHOW" | "SHOW_ALL" | "SHOW_DEPENDANTS" | "SHOW_DEPENDENCIES" | "UNSELECT" | "ZOOM_IN" | "ZOOM_OUT" | "done.invoke.render-graph" | "error.platform.render-graph" | "error.platform.update-layout";
        };
        eventsCausingServices: {
          "renderGraph": "done.invoke.update-layout";
"updateLayout": "FOCUS" | "HIDE" | "HIDE_ALL" | "HIDE_DEPENDANTS" | "HIDE_DEPENDENCIES" | "INITIALIZE" | "SET_THEME" | "SHOW" | "SHOW_ALL" | "SHOW_DEPENDANTS" | "SHOW_DEPENDENCIES";
        };
        matchesStates: "error" | "rendering" | "success" | "uninitialized" | "updating";
        tags: never;
      }
