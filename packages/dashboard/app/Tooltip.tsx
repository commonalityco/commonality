...
const Tooltip = () => {
  ...
  return (
    <div
      id="hello"
      className="z-50 rounded border border-zinc-300 bg-white p-3 text-sm text-zinc-800 shadow dark:border-zinc-600 dark:bg-zinc-900 dark:text-white"
      ref={setPopperElement}
      style={styles.popper}
      {...attributes.popper}
    >
      <Component {...(currentTooltipData.props as any)} />
