...
const iconButtonVariants = cva(
  'rounded transition-all flex items-center justify-center shrink-0',
  {
    variants: {
      size: {
        sm: 'h-7 w-7',
