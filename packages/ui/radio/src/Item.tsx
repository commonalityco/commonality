    ...
    return (
      <div className="flex items-center gap-2">
        <RadixItem
          ...
          id={id}
          ref={ref}
          className="h-4 w-4 rounded-full border border-zinc-100 dark:border-zinc-500 bg-white dark:bg-zinc-800 p-0 relative data-[state=checked]:border-sky-600 data-[state=unchecked]:hover:border-zinc-400]"
        >
