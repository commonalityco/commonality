...
"unselect": "FOCUS" | "HIDE" | "HIDE_ALL" | "HIDE_DEPENDANTS" | "HIDE_DEPENDENCIES" | "ISOLATE" | "NODE_MOUSEOUT" | "SHOW" | "SHOW_ALL" | "SHOW_DEPENDANTS" | "SHOW_DEPENDENCIES" | "UNSELECT";
"zoomIn": "ZOOM_IN";
"zoomOut": "ZOOM_OUT";
        };
        eventsCausingDelays: {
        ...
        eventsCausingGuards: {
          "hasInitialized": "DESTROY" | "EDGE_CLICK" | "FIT" | "FOCUS" | "HIDE" | "HIDE_ALL" | "HIDE_DEPENDANTS" | "HIDE_DEPENDENCIES" | "ISOLATE" | "NODE_CLICK" | "NODE_MOUSEOUT" | "SET_HOVERING" | "SET_THEME" | "SHOW" | "SHOW_ALL" | "SHOW_DEPENDANTS" | "SHOW_DEPENDENCIES" | "UNSELECT" | "ZOOM_IN" | "ZOOM_OUT" | "done.invoke.render-graph" | "error.platform.render-graph" | "error.platform.update-layout";
        };
        eventsCausingServices: {
          "renderGraph": "done.invoke.update-layout";
"updateLayout": "FOCUS" | "HIDE" | "HIDE_ALL" | "HIDE_DEPENDANTS" | "HIDE_DEPENDENCIES" | "INITIALIZE" | "ISOLATE" | "SET_THEME" | "SHOW" | "SHOW_ALL" | "SHOW_DEPENDANTS" | "SHOW_DEPENDENCIES";
        };
