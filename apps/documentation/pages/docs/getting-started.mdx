...
This guide will get you set up in a few seconds and show you how to leverage Commonality to scale your existing JavaScript projects.

<Steps>

### Initialize `commonality`
