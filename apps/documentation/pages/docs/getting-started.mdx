...
<Steps>
  ...
  - **Tooling:** Packages that require common boilerplate or configuration files for tooling. i.e. `buildable`, `deployable`, `testable`

  - **Concern:** Packages that have a common concern or purpose. i.e. `ui`, `data`, `config`.

  - **Domain:** Packages that have a common product vertical or feature. i.e. `checkout`, `marketing`, `ai`
