...
However, we also believe that monorepo architecture unlocks new forms of workflow automation and we want to build that future.
We plan on building a paid platform that will enable some of those workflows at scale for medium to large teams. That platform will
have distinct features built on a foundation of open source tooling.
