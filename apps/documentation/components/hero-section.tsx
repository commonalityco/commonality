...
export function HeroSection() {
  return (
    <div className="px-6 relative pt-2 bg-interactive">
      <div className="absolute top-0 right-0 bottom-0 left-0 pointer-events-none z-10">
      ...
      <div className="flex flex-col items-center justify-center pt-12 gap-6 md:items-stretch z-20 relative">
        <div className="max-w-[800px] relative z-10 flex text-center items-center justify-center md:justify-start self-center md:self-auto mx-auto mb-6">
          <div>
            <h1 className="text-6xl md:text-9xl font-bold text-primary mb-6 leading-none">
              Build bigger
            </h1>
            ...
            <Button
              size="lg"
              asChild
              className="w-full max-w-[200px] md:w-auto font-bold"
            >
        ...
        <div className="flex justify-center grow h-full pointer-events-none">
          <Cube className="z-10 relative max-w-[300px] md:max-w-[400px] min-w-[200px] w-full -mb-16" />
        </div>
      </div>
      <HeroFooter className="w-full pointer-events-none absolute left-0 right-0 -bottom-2 pt-1/3 z-10" />
    </div>
  );
}
